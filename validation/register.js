...
module.exports = function validateRegisterInput(data) {
    ...
    if (!Validator.isLength(data.name, { min: 3, max: 30 })) { errors.name = "Name must be between 3 and 30 characters"; }
    ...
    if (!Validator.isLength(data.password, { min: 6, max: 30 })) { errors.password = "Name must be between 3 and 30 characters"; }
